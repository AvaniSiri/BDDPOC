...
public class CreateMaterialSAPStepDef extends TestContextManager {
    ...
    public void material_should_be_created_for_material_type_in_sap() throws Throwable {
        ...
        System.out.println(testContext.scenarioContext.getContext(TestDataContext.REQUEST_ID));
    ...
    @When("^User logged in as Local Data Specialist (.+)$")
    public void user_logged_in_as_local_data_specialist(String mdmmopcoslds) throws Throwable {
        loginPage.login(mdmmopcoslds, "Heineken01");
    }

    @And("^LDS review and approve the request$")
    public void lds_review_and_approve_the_request() throws Throwable {
        materialPage.reqIdSearchMyTasks((String) testContext.scenarioContext.getContext(TestDataContext.REQUEST_ID));
        materialPage.clickLocalActionButton();
        materialPage.clickMarkAllViewsCompletedButton();
        materialPage.clickCloseButtonToPopUp();
        materialPage.clickApproveBtn();
        materialPage.clickCloseButtonToPopUp();
    }

    @Then("^LDR logged in and checking for syndication completion$")
    public void ldr_logged_in_and_checking_for_syndication_completion() throws Throwable {
        System.out.println("Material moved to syndication and is waiting for syndication to complete");
    }

    @And("^LDS review and reject the request$")
    public void lds_review_and_reject_the_request() throws Throwable {

    }

    @Then("^LDR logged in and resubmit the request$")
    public void ldr_logged_in_and_resubmit_the_request() throws Throwable {
